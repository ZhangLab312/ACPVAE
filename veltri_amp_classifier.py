...
from acp.models.discriminators import discriminator
from acp.models import model


class VeltriACPClassifier(discriminator.Discriminator):
...
class VeltriACPClassifierFactory:

    @staticmethod
    def get_default(max_length: int) -> VeltriACPClassifier:
